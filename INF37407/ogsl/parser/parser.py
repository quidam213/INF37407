...
def get_request_pjson(url : str, params : dict = {}) -> Any:
    params['f'] = 'pjson';
...
def manage_layer(layer : Any) -> None:
...
def manage_feature(feature: Any) -> None:
            ...
            try:
                ...
                for l in layers[COL_NAME_LAYERS]:
                    ...
                    try:
                        ...
                        features : Any = get_request_pjson(sf, params=f_params);
                        print(f"Features Ok for the layer : {l_id}.");
                        for f in features[COL_NAME_FEATURES]:
                            manage_feature(f);
